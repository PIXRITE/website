...
<div class="page_top"> 
    <div class="section_inner">
        <h1 class="page_top--heading">Digital Marketing Services</h1>
...
<div class="page_body">
    <div class="section_inner">
        <div class="page_body--left">  
            <h2>Get found with local search optimization.</h2>
                    <aside class="quote">
                        ...
                        <span class="quote--credit">Lark Meadows Mapes, PIXRITE SEO Strategy &amp; Content</span>    
                    </aside>
        ...
        <div class="page_body--right">
         <div class="columns3"> 
            <div class="floater3">
               <h5>Local Search Utah</h5>
               <p>It's time to get seen online. Phone books are paper weights. If someone types your specialty into Google, your business needs to show up right next to that map at the top of the page and again, just underneath it.</p>
               <a class="grey_button" href="/contact">get started</a>               
            </div>
            
            <div class="floater3">
               <h5>Organic SEO</h5>
               <p>Now is the time to start your organic SEO efforts. They can take a while to show up, but the results offer the highest ROI and potential earnings in the long run.<br><br><br></p>
               <a class="grey_button" href="/contact">get started</a>               
            </div>
            
            <div class="floater3">
               <h5>PPC Management</h5>
               <p>Do you have time to keep your pay-per-click campaign up to date on an hourly or even daily basis? Whether you're spending tens or thousands per month, we can help you account for every dollar!<br><br></p>
               <a class="grey_button" href="/contact">get started</a>               
            </div>
        </div>    
        <img class="promoimage" src="../img/seo_lrg_01.jpg"> 
        <div class="columns2">
           <h5>Utah Online Marketing Services</h5>
           <div class="floater2">
                <ul>
