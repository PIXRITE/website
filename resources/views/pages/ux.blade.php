...
We're one.</p>
                ...
                <h2>The best interfaces never sleep.</h2>
                  <aside class="quote">
                        ...
                        <span class="quote--credit">Lark Meadows Mapes, PIXRITE Content</span>    
                    </aside>
        ...
        <div class="page_body--right">
         <div class="columns3"> 
            <div class="floater3">
               <h5>New GUI Design</h5>
               <p>Designing a new interface requires audience and market analysis, functional vision and a little bit of magic. We handcraft your wireframes, build conceptual walkthroughs, test your audiences and then paint your brand right over the top of everything.</p>
               <a class="grey_button" href="/contact">get started</a>               
            </div>
            
            <div class="floater3">
               <h5>GUI Redesign</h5>
               <p>You know your customers and you've realized your application's face isn't living up to its awesome technology. Let us have a look. Usually reskinning an application can be much less involved that starting from scratch.<br><br></p>
               <a class="grey_button" href="/contact">get started</a>               
            </div>
            
            <div class="floater3">
               <h5>GUI Enhancement</h5>
               <p>Need to push your interface over the edge? From custom icons to skinned widgets, we can add beauty and usability to your project without stepping on others' ideas. After all, no one wants to lose money they've already invested!<br><br></p>
               <a class="grey_button" href="/contact">get started</a>               
            </div>
        </div>    
        <img class="promoimage" src="../img/gui_full_01.png"> 
            <div class="columns2">
               <h5>Application &amp; UX Services</h5>
               <div class="floater2">
                    <ul>
